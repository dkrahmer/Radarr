    ...
    public class ImportMoviesWithImmutableDirectoryFixture : CoreTest<ImportApprovedMovie>
    {
        ...
        public void should_publish_MovieImportedEvent_for_each_file_for_new_download()
        {
            ...
            Mocker.GetMock<IEventAggregator>()
                .Verify(v => v.PublishEvent(It.IsAny<MoviesImportedEvent>()), Times.Exactly(_approvedDecisions.Count));
        }
        ...
        {
            var path = Path.Combine(@"C:\Movies", "Movie Name (2000)", "VIDEO_TS", "VTS_01_0.VOB").AsOsAgnostic();
        ...
        {
            var path = @"C:\Movies\Movie Name (2000)\Movie Name (2000).mkv".AsOsAgnostic();
